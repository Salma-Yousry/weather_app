...
class WeatherScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => WeatherCubit(getIt<GetWeatherUseCase>())..fetchWeather("Cairo", DateTime.now()),
      child: Scaffold(
        backgroundColor: ColorManager.darkBlue,
        appBar: AppBar(
          title: Text("Welcome $fullName",style: getBoldStyle(fontSize: 24.sp, color: ColorManager.white)),
          backgroundColor: ColorManager.darkBlue,
          centerTitle: true,
        ),
