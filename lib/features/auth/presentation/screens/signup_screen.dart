              ...
              child: Column(
                ...
                children: [
                  ...
                  CustomTextFormField(
                    ...
                    validator: (text) => text == null || text.trim().isEmpty ? AppStrings.enter : null,
                  ),
                  CustomTextFormField(
                  ...
                  BlocConsumer<SignupCubit,SignupState>(
                    listener: (context, state) {
                      if (state is SignupLoading) {
                        ...
                        DialogUtils.hideLoading(context);
                        DialogUtils.showMessage(context: context, message: state.error, posActionName: AppStrings.ok);
                      }
                    },
